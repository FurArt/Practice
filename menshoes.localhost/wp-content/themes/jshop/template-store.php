<?php get_header(); ?>   
		...
		<div class="content">
			...
			<div class="post-main">
				...
				<div class="post">
					...
					<?php the_content( '' ); ?><div class="more-link"><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php _e( 'Read more...', 'jshop' ); ?></a></div>
		...
		<?php else : ?>
						<div class="navigation">
							<div class="alignleft"><?php previous_posts_link(__('&laquo; Newer', 'jshop')) ?></div>
							<div class="alignright"><?php next_posts_link(__('Older &raquo;', 'jshop')) ?></div>
						</div>
						<?php endif; ?>
			<?php endif; ?>
		</div>
