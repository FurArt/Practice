...
function jshop_fragment( $fragments ) 
{
    global $woocommerce;
    ob_start(); ?>
    <a class="cart-contents" href="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'jshop'); ?>"><?php echo $woocommerce->cart->get_cart_total(); ?></a>
    <?php
...
<center><b>' . __( 'Localization Ready:', 'jshop' ) . '</b> ' . __( 'Chinese, Czech, Dutch, English, French, German, Greek, Hungarian, Indonesian, Italian, Japanese, Polish, Romana, Russian, Spanish, ... and other.  Add ', 'jshop' ) . '<a href="http://justpx.com/your-language">' . __( 'Your language', 'jshop' ) . '</a>. </center><br/><br/>
<br><br>
<center><h1 style="font-size:79px;">' . __( 'Theme JShop PRO', 'jshop' ) . '</h1></ceter><br><br>
<h1><center>' . __( ' Page ', 'jshop' ) . ' <a href="http://justpx.com/product/jshop-pro" target="_blank">' . __( ' JShop PRO ', 'jshop' ) . '</a>' . __( ' - theme, demo, documentation.', 'jshop' ) . '</center></h1><br><br>
...
<br/><br/>
<br>
<center><img src="' . get_template_directory_uri() . '/images/jshoppro7.png"></center><br><br/><br/><br/><center><img src="' . get_template_directory_uri() . '/images/admin-1.jpg"></center><br/><br/><center><img src="' . get_template_directory_uri() . '/images/admin-2.jpg"></center><br/><br/><center><img src="' . get_template_directory_uri() . '/images/admin-3.jpg"></center><br/><br/><center><img src="' . get_template_directory_uri() . '/images/admin-4.jpg"></center><br/><br/><center><img src="' . get_template_directory_uri() . '/images/admin-5.jpg"></center><br/><br/>
