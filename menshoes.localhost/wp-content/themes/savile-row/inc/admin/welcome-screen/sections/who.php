...
<div id="who" class="feature-section col three-col" style="margin-bottom: 1.618em; padding-top: 1.618em; overflow: hidden;">
	...
	<div class="col-1">
		...
		<p><?php echo sprintf( esc_html__('%1$sVisit Template Express%2$s', 'savile-row'), '<a href="' . esc_url( 'https://www.templateexpress.com' ) . '" class="button">', '</a>'); ?></p>
	</div>
	...
	<div class="col-3 last-feature">
		...
		<p><?php echo sprintf( esc_html__( 'Why not leave a review on %1$sWordPress.org%2$s? We would really appreciate it! :-)', 'savile-row' ), '<a href="' . esc_url( 'https://wordpress.org/themes/savilerow' ) . '">', '</a>' ); ?></p>
	</div>
