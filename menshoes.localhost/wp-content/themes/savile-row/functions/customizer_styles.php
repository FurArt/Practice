...
?>
  ...
  <?php
    $sidebarBGColor = get_theme_mod('sidebar_bg_color_control', '#FFFFFF');
    if( $sidebarBGColor ){?>
      .sidebar{
        background-color: <?php echo esc_attr($sidebarBGColor);?>;
        box-shadow: 100000px 0 0 100000px <?php echo esc_attr($sidebarBGColor);?>;
      }
  <?php
    }
  ?>
